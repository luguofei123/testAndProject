...
function ShowMes(str,mes,type){
	...
	{	
		...
		o.style.left=(XgetPosition(o).x+120)+"px";
		o.style.top=XgetPosition(o).y+"px";
		o.innerHTML=mes;
	  }else
	  {
...
/**
去掉值中的空格。//////要是字符之间超过两个空格的话最后保留一个空格；
输入：value 字符串
返回：去除空格后的字符串
**/
function trim(value) {
